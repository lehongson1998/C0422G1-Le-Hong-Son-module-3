...
public class UserRepository implements IUserRepository {
    ...
    // bai tap 1 goi procedure cho chuc nang hien thi danh sach user.
    @Override
    ...
    // bai tap 1 goi procedure cho chuc nang xoa user theo id.
    @Override
    ...
    // bai tap 1 goi procedure cho chuc nang chinh sua thong tin user.
    @Override
    ...
    // thuc hanh 1 goi procedure cho chuc nang them moi user.
    // bài tập 2 thêm transaction cho haotj động này
    @Override
    public boolean insertUserStore(User user) throws SQLException {
        ...
        try {
             ...
             success = callableStatement.executeUpdate();
             }
             if (success == 1){
                 connection.commit();
                 return true;
    ...
    // thuc hanh 2 goi procedure cho chuc nang them moi user su dung transaction.
    // bai tap 2 Cập nhật phương thức addUserTransaction(), sửa đổi mã nguồn để gây ra lỗi SQL,
    // chạy chương trình và quan sát kết quả, kiểm tra dữ liệu trong cơ sở dữ liệu.
    @Override
    ...
    // thuc hanh 3 edit thong tin user khong su dung transaction.
    @Override
    ...
    // thuc hanh 4 edit thong tin user su dung transaction.
    @Override
